...
#define STRING_CONFIG_H_AUTHOR "(Ruben Oosterwijk, master maker)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Initiating Self destruct in 3... 2... 1..."
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-19, -41, 0 }
